...
def check_for_spare(spareActive, player_score, exit_after_round):
    if spareActive == True and not exit_after_round:
...
for file in files:
    ...
    for i in range(0, len(throws), 2):
        ...
        player_score = check_for_spare(spareActive, player_score, exit_after_round)
